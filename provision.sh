...
apt install -y php7.2 php7.2-mbstring php7.2-xml php7.2-zip php7.2-mysql git nginx software-properties-common python-software-properties python-pip wget nodejs ruby2.0
