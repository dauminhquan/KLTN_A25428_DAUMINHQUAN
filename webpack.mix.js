...
//enterprise
// mix.js('resources/assets/js/admin/enterprises/index/index.js', 'public/assets/js/build/pages/admin/enterprise-manage/enterprise-manage.js');
//
// mix.js('resources/assets/js/admin/enterprises/create/index.js', 'public/assets/js/build/pages/admin/enterprise-manage/add-enterprise.js');
//
// mix.js('resources/assets/js/admin/enterprises/edit/index.js', 'public/assets/js/build/pages/admin/enterprise-manage/info-enterprise.js');
//
// //job
