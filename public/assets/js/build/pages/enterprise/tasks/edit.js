...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content__ = __webpack_require__(82);
...
Component.options.__file = "resources\\assets\\js\\enterprise\\tasks\\edit\\content.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-52ebbabe", Component.options)
  } else {
    hotAPI.reload("data-v-52ebbabe", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_select__ = __webpack_require__(38);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getTask: function getTask() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ENTERPRISE_TASKS_RESOURCE + '/' + vm.keyItem).then(function (data) {
                vm.info = data.data;
            }).catch(function (err) {
                console.log(err);
        ...
        updateTask: function updateTask() {
            ...
            if (_typeof(vm.info.skills) == 'object') {
                pushNew.skills = vm.info.skills.map(function (item) {
                    return item.id;
                });
            }
            if (_typeof(vm.info.positions) == 'object') {
                pushNew.positions = vm.info.positions.map(function (item) {
                    return item.id;
                });
            }
            if (_typeof(vm.info.types) == 'object') {
                pushNew.types = vm.info.types.map(function (item) {
                    return item.id;
                });
            }
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].put(vm.config.API_ENTERPRISE_TASKS_RESOURCE + '/' + vm.keyItem, pushNew).then(function (data) {
                vm.uploading = false;
        ...
        uploadFile: function uploadFile(e) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].post(vm.config.API_ENTERPRISE_TASKS_UPDATE_FILE_ATTACH + '/' + vm.keyItem, formData).then(function (data) {
        ...
        deleteItem: function deleteItem() {
            var vm = this;
            vm.deleting = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].delete(vm.config.API_ENTERPRISE_TASKS_RESOURCE + '/' + vm.keyItem).then(function (data) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-52ebbabe", module.exports)
  }
}
