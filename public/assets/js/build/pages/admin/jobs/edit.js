...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content__ = __webpack_require__(141);
...
Component.options.__file = "resources\\assets\\js\\admin\\jobs\\edit\\content.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f502941e", Component.options)
  } else {
    hotAPI.reload("data-v-f502941e", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_select__ = __webpack_require__(143);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getJob: function getJob() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ADMIN_JOBS_RESOURCE + '/' + vm.keyItem).then(function (data) {
                vm.info = data.data;
        ...
        getTypes: function getTypes() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ADMIN_TYPES_RESOURCE + '?size=-1').then(function (data) {
        ...
        getSkills: function getSkills() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ADMIN_SKILLS_RESOURCE + '?size=-1').then(function (data) {
        ...
        getPositions: function getPositions() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ADMIN_POSITIONS_RESOURCE + '?size=-1').then(function (data) {
        ...
        getSalaries: function getSalaries() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ADMIN_SALARIES_RESOURCE + '?size=-1').then(function (data) {
        ...
        updateJob: function updateJob() {
            var vm = this;
            vm.uploading = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].put(vm.config.API_ADMIN_JOBS_RESOURCE + '/' + vm.keyItem, vm.info).then(function (data) {
                vm.uploading = false;
        ...
        uploadFile: function uploadFile(e) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].post(vm.config.API_ADMIN_JOBS_UPDATE_FILE_ATTACH + '/' + vm.keyItem, formData).then(function (data) {
        ...
        updateAccept: function updateAccept(accept) {
            var vm = this;
            vm.uploading = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].put(vm.config.API_ADMIN_JOBS_RESOURCE + '/' + vm.keyItem, {
        ...
        deleteItem: function deleteItem() {
            var vm = this;
            vm.deleting = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].delete(vm.config.API_ADMIN_JOBS_RESOURCE + '/' + vm.keyItem).then(function (data) {
    ...
    watch: {
        salary: function salary(value) {
            var vm = this;
            vm.info.salary_id = value.id;
        },
        skills: function skills(value) {
            var vm = this;
            vm.info.skills = value.map(function (item) {
                return item.id;
            });
        },
        positions: function positions(value) {
            var vm = this;
            vm.info.positions = value.map(function (item) {
                return item.id;
            });
        },
        types: function types(value) {
            var vm = this;
            vm.info.types = value.map(function (item) {
                return item.id;
            });
        }
    }
            ...
            _c("div", { staticClass: "text-right" }, [
              ...
              _vm.info.accept == 2
                ? _c(
                    ...
                    [
                      _vm._v("Dừng đăng "),
                      _c("i", { staticClass: "icon-stop2 position-right" })
                    ]
                  )
                : _vm._e(),
              _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f502941e", module.exports)
  }
}
