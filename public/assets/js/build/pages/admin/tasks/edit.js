...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content__ = __webpack_require__(14);
...
Component.options.__file = "resources\\assets\\js\\admin\\tasks\\edit\\content.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f05173e", Component.options)
  } else {
    hotAPI.reload("data-v-6f05173e", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__axios__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__config__ = __webpack_require__(38);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getTask: function getTask() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].get(vm.config.API_ADMIN_TASKS_RESOURCE + '/' + vm.keyItem).then(function (data) {
                vm.info = data.data;
        ...
        updateTask: function updateTask() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].put(vm.config.API_ADMIN_TASKS_RESOURCE + '/' + vm.keyItem, vm.info).then(function (data) {
                vm.uploading = false;
        ...
        uploadFile: function uploadFile(e) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].post(vm.config.API_ADMIN_TASKS_UPDATE_FILE_ATTACH + '/' + vm.keyItem, formData).then(function (data) {
        ...
        updateAccept: function updateAccept(accept) {
            var vm = this;
            vm.uploading = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].put(vm.config.API_ADMIN_TASKS_RESOURCE + '/' + vm.keyItem, {
        ...
        deleteItem: function deleteItem() {
            var vm = this;
            vm.deleting = true;
            __WEBPACK_IMPORTED_MODULE_1__axios__["a" /* default */].delete(vm.config.API_ADMIN_TASKS_RESOURCE + '/' + vm.keyItem).then(function (data) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pnotify_dist_es_PNotifyCompat__ = __webpack_require__(39);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PNotify_js__ = __webpack_require__(40);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6f05173e", module.exports)
  }
}
