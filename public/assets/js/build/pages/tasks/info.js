...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__content__ = __webpack_require__(100);
...
Component.options.__file = "resources\\assets\\js\\tasks\\info\\content.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1e27c718", Component.options)
  } else {
    hotAPI.reload("data-v-1e27c718", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
        ...
        TextInfo: function TextInfo() {
            ...
            if (vm.task != null) {
                ...
                if (vm.task.skills != undefined) {
                    vm.task.skills.forEach(function (item) {
                        text += '<mark class="bg-primary">' + item.name + '</mark> ';
                    });
                }
                if (vm.task.positions != undefined) {
                    vm.task.positions.forEach(function (item) {
    ...
    methods: {
        getTask: function getTask() {
            var vm = this;
            __WEBPACK_IMPORTED_MODULE_0__axios__["a" /* default */].get(vm.config.API_TASKS + '/' + vm.keyItem).then(function (data) {
                vm.task = data.data;
            }).catch(function (err) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "content-detached" }, [
            ...
            _c(
              ...
              [
                _c("img", {
                  ...
                  attrs: {
                    src:
                      _vm.task.enterprise == null
                        ? null
                        : _vm.task.enterprise.avatar,
                    alt: ""
                  }
                })
              ]
    ...
    _c("div", { staticClass: "panel panel-flat" }, [
      _c("div", { staticClass: "panel-body" }, [
        ...
        _c("div", {
          domProps: {
            innerHTML: _vm._s(
              _vm.task.enterprise == null ? null : _vm.task.enterprise.introduce
            )
          }
        })
      ])
    ...
    _vm._v(" "),
    _vm.task.similars != undefined && _vm.task.similars.length > 0
      ? _c("h5", { staticClass: "pt-10 content-group" }, [
          _vm._v("Việc làm tường tự")
        ])
      : _vm._e(),
    _vm._v(" "),
    _vm.task.similars != undefined
      ? _c(
          "div",
          { staticClass: "row" },
          _vm._l(_vm.task.similars, function(similar) {
                ...
                [
                  ...
                  _c("div", { staticClass: "media-body" }, [
                    _c("h6", { staticClass: "media-heading text-semibold" }, [
                      _c("a", { attrs: { href: _vm.getUrlTask(similar.id) } }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1e27c718", module.exports)
  }
}
