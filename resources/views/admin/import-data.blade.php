        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                    ...
                    @foreach($tables as $table)
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Import dữ liệu vào bảng <b>{{$table['name']}}</b></label>
                ...
                <div class="text-right">
                    ...
                    <button type="submit" class="btn btn-primary">Import <i class="icon-arrow-right14 position-right"></i></button>
                </div>
            </div>
        </div>
    </form>
