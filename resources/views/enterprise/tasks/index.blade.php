    ...
    <div class="page-header-content">
        <div class="page-title">
            ...
            <ul class="breadcrumb breadcrumb-caret position-right">
                ...
                <li><a href="{{route('enterprise.tasks.index')}}">Quản lý việc làm</a></li>
...
@section("js-page")
    <script type="text/javascript" src="{{asset("assets/js/build/pages/enterprise/tasks/index.js")}}"></script>
@endsection
@section('theme-asset')
@endsection