<template>
    <div class="content-wrapper" id="content-wrapper">
        <data-table title="Quản lý đánh giá tốt nghiệp"
                    :columns="columns"
                    :data="data"
                    :targets="[]"
                        ...
                        <div class="modal-body">
                           ...
                           <div class="row">
                               <div class="form-group">
                                   <label><b>Tên đánh giá tốt nghiệp</b></label>
    ...
    export default {
        ...
        data(){
            return {
                ...
                menu: [
                    ...
                    {
                        action :'delete',
                        html:'<a href="javascript:void(0);"><i class="icon-trash"></i> Xóa đánh giá tốt nghiệp</a>'
                    }
                ],
                primaryKey: 'id',
        ...
        methods: {
            ...
            getData(perPage=500,page=1){
                var vm = this
                axios.get(vm.config.API_ADMIN_RATINGS_RESOURCE+'?size='+perPage+'&page='+page).then(data => {
            ...
            createItem(){
                let vm = this
                vm.creating = true
                axios.post(vm.config.API_ADMIN_RATINGS_RESOURCE,{
                    name:vm.nameCreate
                }).then(data => {
            ...
            updateItem(){
                let vm = this
                vm.updating = true
              axios.put(vm.config.API_ADMIN_RATINGS_RESOURCE+'/'+vm.info.id,{
                  name:vm.info.name
              }).then(data => {
            ...
            deleteItem(){
                ...
                {
                    let indexOf = -1
                    axios.delete(vm.config.API_ADMIN_RATINGS_RESOURCE+'/'+vm.primaryKeyDelete).then(data => {
            ...
            deleteListItem() {
                let vm = this
                vm.deleting = true
                axios.delete(vm.config.API_ADMIN_RATINGS_DELETE_LIST,{
                    params:{
