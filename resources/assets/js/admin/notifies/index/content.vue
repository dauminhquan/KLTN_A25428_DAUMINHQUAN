<template>
    <div class="content-wrapper" id="content-wrapper">
        <data-table title="Quản lý thông báo"
                    :columns="columns"
                    :data="data"
                    :targets="[]"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p> <i class="icon-warning"></i> Bạn đang xóa nhiều thông báo. Sau khi xóa, mọi dữ liệu liên quan sẽ bị xóa. Bạn nên cân nhắc điều này ! </p>
                            <div style="border: snow" class="panel panel-body border-top-danger text-center">
                                <div class="pace-demo" v-if="deleting == true">
                                    <div class="theme_xbox_xs"><div class="pace_progress" data-progress-text="60%" data-progress="60"></div><div class="pace_activity"></div></div>
                                </div>
    ...
    export default {
        ...
        data(){
            return {
                ...
                menu: [
                    ...
                    {
                        action :'delete',
                        html:'<a href="javascript:void(0);"><i class="icon-trash"></i> Xóa thông báo</a>'
                    }
                ],
                primaryKey: 'id',
        ...
        methods: {
            ...
            getData(perPage=500,page=1){
                var vm = this
                axios.get(vm.config.API_ADMIN_NOTIFIES_RESOURCE+'?size='+perPage+'&page='+page).then(data => {
            ...
            deleteItem(){
                ...
                {
                    let indexOf = -1
                    axios.delete(vm.config.API_ADMIN_NOTIFIES_RESOURCE+'/'+vm.primaryKeyDelete).then(data => {
            ...
            deleteListItem() {
                let vm = this
                vm.deleting = true
                axios.delete(vm.config.API_ADMIN_NOTIFIES_DELETE_LIST,{
                    params:{
