    ...
    export default {
        ...
        methods: {
            ...
            getData(perPage=500,page=1){
                var vm = this
                axios.get(vm.config.API_ADMIN_TASKS_RESOURCE+'?size='+perPage+'&page='+page).then(data => {
            ...
            deleteItem(){
                ...
                {
                    let indexOf = -1
                    axios.delete(vm.config.API_ADMIN_TASKS_RESOURCE+'/'+vm.primaryKeyDelete).then(data => {
            ...
            deleteListItem() {
                let vm = this
                vm.deleting = true
                axios.delete(vm.config.API_ADMIN_TASKS_DELETE_LIST,{
                    params:{
            ...
            showItem(id) {
                let vm = this
                window.open(vm.config.WEB_ADMIN_TASKS+'/'+id+'/edit','_blank')
            },
