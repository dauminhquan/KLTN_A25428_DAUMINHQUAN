    ...
    export default {
        ...
        data(){
            return {
                ...
                menu: [
                    ...
                    {
                        action :'delete',
                        html:'<a href="javascript:void(0);"><i class="icon-trash"></i> Xóa chức vụ trong công việc</a>'
                    }
                ],
                primaryKey: 'id',
        ...
        methods: {
            ...
            getData(perPage=500,page=1){
                var vm = this
                axios.get(vm.config.API_ADMIN_RANKS_RESOURCE+'?size='+perPage+'&page='+page).then(data => {
            ...
            createItem(){
                let vm = this
                vm.creating = true
                axios.post(vm.config.API_ADMIN_RANKS_RESOURCE,{
                    name:vm.nameCreate
                }).then(data => {
            ...
            updateItem(){
                let vm = this
                vm.updating = true
              axios.put(vm.config.API_ADMIN_RANKS_RESOURCE+'/'+vm.info.id,{
                  name:vm.info.name
              }).then(data => {
            ...
            deleteItem(){
                ...
                {
                    let indexOf = -1
                    axios.delete(vm.config.API_ADMIN_RANKS_RESOURCE+'/'+vm.primaryKeyDelete).then(data => {
            ...
            deleteListItem() {
                let vm = this
                vm.deleting = true
                axios.delete(vm.config.API_ADMIN_RANKS_DELETE_LIST,{
                    params:{
